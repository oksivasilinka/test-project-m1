...
- Propose enhancements to the existing logic (implementation optional, but detailed description required). 

> 👉 Fork the repository and share a link to your completed solution. All your work, findings, and suggestions should be documented in a Markdown file named `SOLUTION_REPORT.md`.
